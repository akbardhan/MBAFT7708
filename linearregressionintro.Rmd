...
---
This file contains R-codes to run multiple regression on a clean dataset. It assumes minimal prior knowledge of R. To use it directly, download and run this file in R-Studio (with R already installed in the machine). Remeber to change the file names / paths etc. wherever required. Let's get started.  
